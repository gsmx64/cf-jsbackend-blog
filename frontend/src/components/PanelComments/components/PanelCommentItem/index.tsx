...
const PanelCommentItem = ({ id, author_id, author_username, author_avatar, author_status, post_id, post_title,
  message, createAt, updateAt, row_state, onCommentItemEditComment, onCommentItemDeleteComment }: any) => {
  ...
  return (
    <div className={"item-list row " + row_state}>
      ...
      <div className="col-4">
        <textarea id={`comment-textarea-${id}`} value={message} className="form-control" rows={1}></textarea>
      </div>
      <div className="col">
      ...
      <div className="col">
        <button className="btn btn-outline-secondary" onClick={handleCommentItemEditComment}>
          <i className="bi bi-pencil-square"></i>
        </button>
        <button className="btn btn-outline-secondary ms-1" onClick={handleCommentItemDeleteComment}>
