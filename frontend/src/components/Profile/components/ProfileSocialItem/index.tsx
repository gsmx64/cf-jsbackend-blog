      ...
      <ul className="list-group list-group-flush">
        (social.website) && (
          <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
            ...
            <span className="text-secondary">{social.website}</span>
          </li>
        )
        (social.website) && (
          <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
        ...
        (social.website) && (
          <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
            ...
            <span className="text-secondary">{social.instagram}</span>
          </li>
        )
        (social.website) && (
          <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
            ...
            <span className="text-secondary">{social.facebook}</span>
          </li>
        )
      </ul>
    </div>
