...
const RegisterForm = ({ currentUser, settings, isSetup, loading, alertMessage, errorMessage, onRegisterUserSaveClick }: any) => {
          ...
          <div className="card mb-3">
            <div className="card-body">
              <h6 className="d-flex align-items-center mb-3">
                <i className="material-icons text-info mr-2 pe-1">Register</i>
              </h6>
              <form
                      ...
                      <div className="text-center mb-3">
                        {
                          ...
                          (
                            <button
                              type="submit"
                              className={(isSetup && alertMessage && !errorMessage) ? "btn btn-secondary btn-block mt-2" : "btn btn-primary btn-block mt-2"}
